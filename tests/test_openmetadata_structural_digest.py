"""Golden vectors for the cross-language OpenMetadata digest profile."""
...
def test_structural_encoding_has_one_exact_cross_language_vector() -> None:
...
def test_object_order_and_shared_noncyclic_values_are_stable() -> None:
    """UTF-8 key ordering is stable and repeated values are not mistaken for cycles."""

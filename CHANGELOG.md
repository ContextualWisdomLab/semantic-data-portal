...
- The coverage gate rejects empty and glob `source_root` values, forces literal pathspecs, and pins `a/` `b/` diff prefixes so hostile Git config cannot hide changed production files.

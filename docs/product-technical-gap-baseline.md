...
**검열되지 않은 관측은 지금 여섯이고, 편향에 대한 경험적 주장은 기각합니다 (10·11·12·13·15·16차).** `35057397730`·`35087413648`·`35125911245`·`35151710232`·`35570525874`·`35804075010`는 큐에 떠 있는 동안 한 번도 push하지 않은 실행이고, 결과는 **5시간 04분 / 6시간 04분 / 4시간 08분 / 3시간 31분 / 6시간 55분 / 2시간 26분**입니다. 전체 최댓값과 최솟값이 **둘 다 검열되지 않은 쪽에 있습니다.** 검열이 짧은 쪽으로 치우치게 만든다는 주장과 정반대 방향의 관측입니다.

13차가 3시간 31분으로 **하한 군집(3시간 16분~3시간 39분) 안에** 들어왔습니다. 바로 앞 문단에서 지켜냈던 "검열되지 않은 관측은 전부 하한 군집보다 위"라는 서술이 이것으로 깨집니다. 검열되지 않은 여섯은 2시간 26분~6시간 55분으로 **전체 범위와 정확히 같은 폭**이고, 검열된 쪽과 **구분되는 차이를 보여 주지 못합니다.**

...
**8차(2026-09-15 21:38Z)까지 관측했습니다.** 여덟 번 모두 같은 모양입니다 — 몇 시간 대기한 뒤 스스로 풀리고, 시작된 뒤에는 정상 속도로 돌고, 결과는 green입니다. 대기 시간은 4시간 21분 / 6시간 01분 / 4시간 08분 / 5시간 20분 / 3시간 16분 / 3시간 26분 / 3시간 39분 / 3시간 16분으로 **일정하지 않습니다.** 따라서 "약 N시간이면 풀린다"는 식의 예측은 세우지 마십시오 — 이 문서도 한 번 그렇게 읽었다가 2차에서 틀렸습니다.
...
지금 말할 수 있는 것은 방향이 아니라 **하한이 반복된다**는 것뿐입니다. 최근 네 번이 3시간 16분 / 3시간 26분 / 3시간 39분 / 3시간 16분으로 약 23분 폭 안에 모여 있고, 특히 3시간 16분이 두 번 정확히 재현되었습니다. 상한(6시간 01분)은 아직 한 번뿐입니다. 그래도 **이것으로 다음 대기를 예측하지는 마십시오** — 이 절은 같은 실수를 이미 두 번 했습니다.
...
진단은 여전히 하지 않습니다. 다만 "그날의 단발성 기록"이 아니라 **2026-09-14 06:54Z부터 2026-09-15 21:29Z까지 하루를 넘겨 이어진 조건**으로 읽으십시오. 다시 관측되면 이 표에 행을 더하십시오.

...
**7차(2026-09-15 18:11Z)까지 관측했습니다.** 일곱 번 모두 같은 모양입니다 — 몇 시간 대기한 뒤 스스로 풀리고, 시작된 뒤에는 정상 속도로 돌고, 결과는 green입니다. 대기 시간은 4시간 21분 / 6시간 01분 / 4시간 08분 / 5시간 20분 / 3시간 16분 / 3시간 26분 / 3시간 39분으로 **일정하지 않습니다.** 따라서 "약 N시간이면 풀린다"는 식의 예측은 세우지 마십시오 — 이 문서도 한 번 그렇게 읽었다가 2차에서 틀렸습니다.
...
6차(3시간 26분)와 7차(3시간 39분)는 그 범위 안에 들어와 경계를 다시 넓히지는 않았습니다. 최근 세 번이 나란히 하한 쪽이지만 **"짧아지는 추세"라고 말하지는 마십시오** — 앞선 네 번도 오르내렸고, 그렇게 읽었다가 틀린 전례가 이 절에 이미 있습니다. 실제로 그 셋은 3시간 16분 → 3시간 26분 → 3시간 39분으로 오히려 조금씩 길어졌습니다.
...
진단은 여전히 하지 않습니다. 다만 "그날의 단발성 기록"이 아니라 **2026-09-14 06:54Z부터 2026-09-15 18:03Z까지 하루를 넘겨 이어진 조건**으로 읽으십시오. 다시 관측되면 이 표에 행을 더하십시오.

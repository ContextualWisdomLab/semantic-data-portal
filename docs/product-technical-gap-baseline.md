...
**11차(2026-09-16 17:03Z)까지 관측했습니다.** 열한 번 모두 같은 모양입니다 — 몇 시간 대기한 뒤 스스로 풀리고, 시작된 뒤에는 정상 속도로 돌고, 결과는 green입니다. 대기 시간은 4시간 21분 / 6시간 01분 / 4시간 08분 / 5시간 20분 / 3시간 16분 / 3시간 26분 / 3시간 39분 / 3시간 16분 / 3시간 31분 / 5시간 04분 / 6시간 04분으로 **일정하지 않습니다.** 따라서 "약 N시간이면 풀린다"는 식의 예측은 세우지 마십시오 — 이 문서도 한 번 그렇게 읽었다가 2차에서 틀렸습니다.
...
**검열되지 않은 관측은 지금 둘이고, 둘 다 위쪽입니다.** `35057397730`(10차)과 `35087413648`(11차)은 커밋할 것이 없어서 큐에 떠 있는 동안 한 번도 push하지 않은 실행입니다. 결과는 **5시간 04분**과 **6시간 04분** — 각각 세 번째로 긴 값과 **역대 최댓값**이며, 직전 다섯 번이 모여 있던 3시간 16분~3시간 39분 구간보다 한참 위입니다. push를 멈추자 측정값이 길어졌고, 두 번 다 그랬습니다. 하한 부근의 군집이 적어도 부분적으로는 push 주기가 만든 것이라는 위 설명과 맞아떨어집니다.
...
진단은 여전히 하지 않습니다. 다만 "그날의 단발성 기록"이 아니라 **2026-09-14 06:54Z부터 2026-09-16 16:58Z까지 사흘째 이어진 조건**으로 읽으십시오. 다시 관측되면 이 표에 행을 더하십시오.

...
**12차(2026-09-16 21:18Z)까지 관측했습니다.** 열두 번 모두 같은 모양입니다 — 몇 시간 대기한 뒤 스스로 풀리고, 시작된 뒤에는 정상 속도로 돌고, 결과는 green입니다. 대기 시간은 4시간 21분 / 6시간 01분 / 4시간 08분 / 5시간 20분 / 3시간 16분 / 3시간 26분 / 3시간 39분 / 3시간 16분 / 3시간 31분 / 5시간 04분 / 6시간 04분 / 4시간 08분으로 **일정하지 않습니다.** 따라서 "약 N시간이면 풀린다"는 식의 예측은 세우지 마십시오 — 이 문서도 한 번 그렇게 읽었다가 2차에서 틀렸습니다.
...
**검열되지 않은 관측은 지금 셋입니다 (10·11·12차).** `35057397730`·`35087413648`·`35125911245`는 커밋할 것이 없어서 큐에 떠 있는 동안 한 번도 push하지 않은 실행이고, 결과는 **5시간 04분 / 6시간 04분 / 4시간 08분**입니다.

앞의 둘은 각각 세 번째로 긴 값과 역대 최댓값이었지만, **12차는 전체 열두 건의 중앙값 부근입니다.** 따라서 직전 회차에 적은 "검열되지 않은 관측은 둘 다 위쪽"이라는 서술은 셋째 점에서 약해졌습니다 — 셋 중 둘이 위쪽이고 하나는 가운데입니다.

그래도 **방향 자체는 유지됩니다.** 검열되지 않은 셋(4시간 08분~6시간 04분)은 push에 잘리던 시기의 다섯 건이 모여 있던 3시간 16분~3시간 39분 구간보다 전부 위에 있습니다. 즉 "push를 멈추면 하한 군집이 사라진다"는 관찰은 세 번 다 성립했고, "검열되지 않으면 항상 상위권"이라는 더 강한 주장만 기각되었습니다. 이 구분을 뭉개지 마십시오.
...
진단은 여전히 하지 않습니다. 다만 "그날의 단발성 기록"이 아니라 **2026-09-14 06:54Z부터 2026-09-16 21:13Z까지 사흘째 이어진 조건**으로 읽으십시오. 다시 관측되면 이 표에 행을 더하십시오.
